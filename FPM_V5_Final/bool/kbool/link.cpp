...
bool KBoolLink::IsMarked( BOOL_OP operation )
{
    ...
    {
    case( BOOL_OR ):
        return m_merge_L || m_merge_R;
    case( BOOL_AND ):
        return m_intersect_L || m_intersect_R;
    case( BOOL_A_SUB_B ):
        return m_a_substract_b_L || m_a_substract_b_R;
    case( BOOL_B_SUB_A ):
        return m_b_substract_a_L || m_b_substract_a_R;
    case( BOOL_EXOR ):
        return m_exor_L || m_exor_R;
    default:
        return false;
    }
}
...
bool KBoolLink::IsMarkedLeft( BOOL_OP operation )
{
    ...
    case( BOOL_OR ):
        return m_merge_L;
    case( BOOL_AND ):
        return m_intersect_L;
    case( BOOL_A_SUB_B ):
        return m_a_substract_b_L;
    case( BOOL_B_SUB_A ):
        return m_b_substract_a_L;
    case( BOOL_EXOR ):
        return m_exor_L;
    default:
        return false;
...
bool KBoolLink::IsMarkedRight( BOOL_OP operation )
{
    ...
    case( BOOL_OR ):
        return m_merge_R;
    case( BOOL_AND ):
        return m_intersect_R;
    case( BOOL_A_SUB_B ):
        return m_a_substract_b_R;
    case( BOOL_B_SUB_A ):
        return m_b_substract_a_R;
    case( BOOL_EXOR ):
        return m_exor_R;
    default:
        return false;
...
// assert(center==third->endnode || center==third->beginnode);
    ...
    case IS_LEFT :
        if ( ( ThirdToOne == IS_RIGHT ) || ( ThirdToTwo == IS_RIGHT ) ) return IS_RIGHT;
